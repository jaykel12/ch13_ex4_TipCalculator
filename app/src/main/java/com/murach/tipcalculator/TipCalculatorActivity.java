...
implements OnEditorActionListener, OnClickListener {
    ...
    public void onResume() {
        ...
        //loop
        for(Tip tip : tips){
            Log.d("TipCal", "dateMillis: " + tip.getDateMillis());
            Log.d("TipCal", "billAmount: " + tip.getBillAmount());
            Log.d("TipCal", "tipPercent: " + tip.getTipPercent());
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.saveButton:
                Tip tip = new Tip();
                long insertId = tipDB.insertTip(tip);
